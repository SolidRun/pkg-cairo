...
extern void _register_meta_surface_pattern (void);
...
extern void _register_random_intersections (void);
...
_cairo_test_runner_register_tests (void)
{
    ...
    _register_random_intersections ();
    ...
    _register_mime_data ();
    _register_meta_surface_pattern ();
